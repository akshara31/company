...
function OCreateEmployee() {
    ...
    return (    
    <div className='d-flex flex-column vh-100 justify-content-center align-items-center' style={{ height: '100vh', backgroundColor: '#92B4F4' }}> 
        <div>
...
export default OCreateEmployee